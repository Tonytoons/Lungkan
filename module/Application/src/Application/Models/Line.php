...
class Line { 
    ...
    { 
        ...
        $this->_CLIENT_ID = $this->config['line_config']['client_id'];
        $this->_CLIENT_SECRET = $this->config['line_config']['client_secret'];
        $this->_CALLBACK_URL = $this->config['line_config']['callback_url'];  
        //$this->return_url  = "http" . (($_SERVER['SERVER_PORT'] == 443) ? "s://" : "://") . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; 
    }    

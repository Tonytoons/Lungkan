...
################################################################################ 
    ...
    {
        $sql = "SELECT id, cate_id, name_en AS name, image, createdate, lastupdate, status, sort_order, views
                FROM ".$this->table." 
        ...
        foreach($data as $kay=>$value){
            ...
            $value['views'] = number_format($value['views']);  
            $items[] = $value;  
        }

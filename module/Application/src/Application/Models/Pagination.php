...
class Pagination
{
     ...
     * 
     * @see    <https://twitter.github.com/bootstrap/components.html#pagination>
     * @access public
     * @param  mixed $classes
     * @return void
     */
    ...
    public function getCanonicalUrl()
    {
        ...
        if ($page !== 1) {
            return 'https://' . ($_SERVER['HTTP_HOST']) . ($target) . $this->getPageParam();
        }
    ...
    public function getPageUrl($page = false)
    {
        ...
        return 'https://' . ($_SERVER['HTTP_HOST']) . ($target) . ($this->getPageParam($page));
    }
    /**
     * getRelPrevNextLinkTags
     * 
     * @see    https://support.google.com/webmasters/bin/answer.py?hl=en&answer=1663744
     * @see    https://googlewebmastercentral.blogspot.ca/2011/09/pagination-with-relnext-and-relprev.html
     * @see    https://support.google.com/webmasters/bin/answer.py?hl=en&answer=139394
     * @access public
     * @return array
     */
    public function getRelPrevNextLinkTags()
    {
        ...
        $href = 'https://' . ($_SERVER['HTTP_HOST']) . $href;
        // Pages
